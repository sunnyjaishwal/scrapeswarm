    ...
    def __init__(self):
        ...
        self.payload = {
            ...
            "itineraries": [{
                ...
                "departureDateTime": "2025-06-09T00:00:00.000",
...
if __name__ == "__main__":
    etihad_request = EtihadApiRequest()
    response = etihad_request.send_request()
    data = etihad_request.process_response(response)